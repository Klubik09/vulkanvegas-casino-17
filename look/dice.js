...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-3c08f2c2');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-3c08f2c2');}
...
function clearFlash(){dieView.classList.remove('rl-win-3c08f2c2');dieView.classList.remove('rl-lose-3c08f2c2');if(frameEl){frameEl.classList.remove('rl-win-3c08f2c2');frameEl.classList.remove('rl-lose-3c08f2c2');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-3c08f2c2');if(frameEl){frameEl.classList.add('rl-win-3c08f2c2');}}else{dieView.classList.add('rl-lose-3c08f2c2');if(frameEl){frameEl.classList.add('rl-lose-3c08f2c2');}}
...
var brandEl=document.querySelector('.rl-brand-3c08f2c2');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
